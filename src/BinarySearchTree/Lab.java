    ...
    public static void bstSystem() {
        ...
        do {
            ...
            if(c == 1){
                ...
                System.out.println("this functionality is broken for now");
...
//                }
                ...
                if(q.isFullBST())
                    System.out.println("A full binary search tree\n");
                else
                    System.out.println("Not a full binary search tree\n");
